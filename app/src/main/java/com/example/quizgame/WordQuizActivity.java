...
public class WordQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager lm = new LinearLayoutManager(WordQuizActivity.this);

        List<WordItem> wordList = Arrays.asList(item);
        //สร้างAderter object
        MyAdapter adapter = new MyAdapter(WordQuizActivity.this, wordList);
...
class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.resouresitem,parent,false);
